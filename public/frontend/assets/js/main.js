(function () {
  ...
  if (recipesPage) {
    const recipes = [
      ["hyderabadi-biryani","Biryani","Hyderabadi Biryani","Authentic Hyderabadi dum biryani layered with aromatic spices and tender meat.","Chicken, Basmati, Saffron",90,"Medium","Hot",520,4.9,980,"https://images.unsplash.com/photo-1701579231305-d84d8af9a3fd?auto=format&fit=crop&w=900&q=85"],
      ["lucknowi-biryani","Biryani","Lucknowi Biryani","Delicate and fragrant biryani cooked with subtle spices and royal touch.","Basmati, Saffron",90,"Medium","Medium",480,4.8,860,"https://images.unsplash.com/photo-1694849789325-914b71ab4075?auto=format&fit=crop&w=900&q=85"],
      ["paneer-tikka","Starters","Paneer Tikka","Cottage cheese cubes marinated in spices and grilled to perfection.","Paneer",30,"Easy","Medium",310,4.7,740,"https://images.unsplash.com/photo-1628294895950-9805252327bc?auto=format&fit=crop&w=900&q=85"],
      ["butter-chicken","Main Course","Butter Chicken","Creamy, rich and flavorful chicken curry that melts in your mouth.","Chicken",45,"Medium","Medium",610,4.9,1100,"https://images.unsplash.com/photo-1603894584373-5ac82b2ae398?auto=format&fit=crop&w=900&q=85"],
      ["samosa","Snacks","Samosa","Crispy golden pastry stuffed with spiced potatoes and green peas.","Rice",40,"Medium","Mild",260,4.6,620,"https://images.unsplash.com/photo-1601050690597-df0568f70950?auto=format&fit=crop&w=900&q=85"],
      ["dal-makhani","Main Course","Dal Makhani","Slow-cooked black lentils in creamy tomato gravy with Indian spices.","Basmati",60,"Medium","Mild",430,4.8,780,"https://images.unsplash.com/photo-1546833999-b9f581a1996d?auto=format&fit=crop&w=900&q=85"],
      ["gulab-jamun","Desserts","Gulab Jamun","Soft and spongy milk solids dumplings soaked in saffron sugar syrup.","Saffron",50,"Easy","Mild",330,4.8,690,"https://images.unsplash.com/photo-1605197161470-d0261cac6767?auto=format&fit=crop&w=900&q=85"],
      ["jeera-rice","Rice","Jeera Rice","Fragrant basmati rice tempered with cumin and whole spices.","Rice, Basmati",25,"Easy","Mild",240,4.5,410,"https://images.unsplash.com/photo-1512058564366-18510be2db19?auto=format&fit=crop&w=900&q=85"],
      ["mutton-biryani","Biryani","Mutton Biryani","Flavourful mutton biryani cooked with aromatic spices and basmati rice.","Mutton, Basmati, Saffron",120,"Hard","Hot",650,4.9,920,"https://images.unsplash.com/photo-1631515242808-497c3fbd3972?auto=format&fit=crop&w=900&q=85"],
      ["hara-bhara-kebab","Starters","Hara Bhara Kebab","Healthy and delicious kebabs made with spinach, peas and potatoes.","Paneer",35,"Easy","Mild",220,4.4,380,"https://images.unsplash.com/photo-1604908176997-125f25cc6f3d?auto=format&fit=crop&w=900&q=85"],
      ["kadai-paneer","Main Course","Kadai Paneer","Cottage cheese cooked with bell peppers in a spicy kadai masala.","Paneer",40,"Medium","Medium",420,4.7,610,"https://images.unsplash.com/photo-1631452180519-c014fe946bc7?auto=format&fit=crop&w=900&q=85"],
      ["kheer","Desserts","Kheer","Creamy rice pudding flavored with cardamom, saffron and nuts.","Rice, Saffron",60,"Easy","Mild",310,4.6,520,"https://images.unsplash.com/photo-1606313564200-e75d5e30476c?auto=format&fit=crop&w=900&q=85"],
      ["veg-biryani","Biryani","Veg Biryani","Aromatic vegetarian biryani packed with herbs, vegetables and spices.","Basmati, Saffron",75,"Medium","Medium",390,4.5,540,"https://images.unsplash.com/photo-1563379091339-03246963d96c?auto=format&fit=crop&w=900&q=85"],
      ["chicken-tikka","Starters","Chicken Tikka","Juicy chicken pieces marinated in spices and grilled over high heat.","Chicken",35,"Medium","Hot",340,4.8,830,"https://images.unsplash.com/photo-1599487488170-d11ec9c172f0?auto=format&fit=crop&w=900&q=85"],
      ["chole-masala","Main Course","Chole Masala","North Indian chickpea curry with bold masala and tangy notes.","Basmati",50,"Medium","Medium",360,4.6,470,"https://images.unsplash.com/photo-1610057099431-d73a1c9d2f2f?auto=format&fit=crop&w=900&q=85"],
      ["gajar-halwa","Desserts","Gajar Halwa","Classic carrot halwa slow cooked with milk, ghee and nuts.","Saffron",70,"Easy","Mild",370,4.7,590,"https://images.unsplash.com/photo-1606890737304-57a1ca8a5b62?auto=format&fit=crop&w=900&q=85"],
      ["pulao","Rice","Vegetable Pulao","Lightly spiced basmati rice cooked with vegetables and whole spices.","Rice, Basmati",35,"Easy","Mild",290,4.4,360,"https://images.unsplash.com/photo-1596797038530-2c107229654b?auto=format&fit=crop&w=900&q=85"],
      ["fish-biryani","Biryani","Fish Biryani","Coastal-style fish biryani with fresh herbs and aromatic rice.","Basmati, Saffron",65,"Medium","Hot",510,4.6,420,"https://images.unsplash.com/photo-1631515243349-e0cb75fb8d3a?auto=format&fit=crop&w=900&q=85"],
      ["aloo-tikki","Snacks","Aloo Tikki","Crispy potato patties with spices and chutney-ready texture.","Rice",30,"Easy","Medium",250,4.5,390,"https://images.unsplash.com/photo-1606491956689-2ea866880c84?auto=format&fit=crop&w=900&q=85"],
      ["paneer-butter-masala","Main Course","Paneer Butter Masala","Creamy paneer curry with buttery tomato gravy and mild spices.","Paneer",45,"Easy","Mild",450,4.8,760,"https://images.unsplash.com/photo-1631452180519-c014fe946bc7?auto=format&fit=crop&w=900&q=85"],
      ["phirni","Desserts","Phirni","Silky ground rice dessert scented with cardamom and saffron.","Rice, Saffron",55,"Easy","Mild",300,4.5,330,"https://images.unsplash.com/photo-1606313564200-e75d5e30476c?auto=format&fit=crop&w=900&q=85"],
      ["lemon-rice","Rice","Lemon Rice","Bright South Indian rice tempered with mustard, curry leaves and peanuts.","Rice",25,"Easy","Mild",230,4.3,290,"https://images.unsplash.com/photo-1512058564366-18510be2db19?auto=format&fit=crop&w=900&q=85"],
      ["seekh-kebab","Starters","Seekh Kebab","Smoky minced kebabs seasoned with royal Indian spices.","Mutton",50,"Hard","Hot",420,4.7,640,"https://images.unsplash.com/photo-1604908176997-125f25cc6f3d?auto=format&fit=crop&w=900&q=85"],
    ...
    const sort = document.querySelector("#recipeSort");
    const pagination = document.querySelector("#recipePagination");
    const empty = document.querySelector("#noRecipesFound");
    const toast = document.querySelector("#recipeToast");
    const quickBody = document.querySelector("#recipeQuickBody");
    let bookmarks = JSON.parse(localStorage.getItem("svaadvika-recipe-bookmarks") || "[]");
    let state = { filters: {}, search: "", sort: "latest", page: 1 };
    const spiceIcon = (level) => level === "Hot" ? "🌶️🌶️🌶️" : level === "Medium" ? "🌶️🌶️" : "🌶️";
    const timeGroup = (m) => m < 30 ? "Under 30 Minutes" : m <= 60 ? "30-60 Minutes" : m <= 120 ? "1-2 Hours" : "More than 2 Hours";
    const dietFor = (r) => r.ingredients.includes("Chicken") || r.ingredients.includes("Mutton") ? "Non-Vegetarian" : r.ingredients.includes("Paneer") ? "Vegetarian" : "Vegan";
    const perPage = () => window.innerWidth < 768 ? 6 : window.innerWidth < 992 ? 8 : 12;
    const showToast = (msg, icon = "bi-check-circle-fill") => { if (!toast) return; toast.querySelector("i").className = `bi ${icon}`; toast.querySelector("span").textContent = msg; window.bootstrap?.Toast.getOrCreateInstance(toast).show(); };
    function filterMarkup() {
      return Object.entries(filterSets).map(([group, items]) => `<div class="recipe-filter-group"><h3>${group}<i class="bi bi-chevron-up"></i></h3>${items.map((item) => `<label class="recipe-check"><input type="checkbox" data-recipe-filter="${group}" value="${item}"><span>${item}</span><small>${recipes.filter((r) => matchesFilter(r, group, item)).length || ""}</small></label>`).join("")}${group === "Ingredients (Include)" ? '<button class="clear-filter" type="button">+ View More</button>' : ""}</div>`).join("");
    }
    function matchesFilter(recipe, group, value) {
      if (group === "Categories") return recipe.category === value;
      if (group === "Cooking Time") return timeGroup(recipe.time) === value;
      if (group === "Diet") return dietFor(recipe) === value;
      if (group === "Spice Level") return recipe.spice === value;
      return recipe.ingredients.includes(value);
    }
    function readFilters() {
      state.filters = {};
      document.querySelectorAll("#recipeFilters input:checked, #recipeMobileFilters input:checked").forEach((input) => {
        state.filters[input.dataset.recipeFilter] = state.filters[input.dataset.recipeFilter] || [];
        if (!state.filters[input.dataset.recipeFilter].includes(input.value)) state.filters[input.dataset.recipeFilter].push(input.value);
      });
    }
    function highlight(text) {
      if (!state.search) return text;
    ...
    function list() {
      readFilters();
      const query = state.search.toLowerCase();
      const out = recipes.filter((recipe) => {
        const searchable = `${recipe.title} ${recipe.category} ${recipe.ingredients} ${recipe.description}`.toLowerCase();
        const filtersOk = Object.entries(state.filters).every(([group, values]) => values.length === 0 || values.some((value) => matchesFilter(recipe, group, value)));
        return filtersOk && (!query || searchable.includes(query));
      });
      out.sort((a,b) => state.sort === "popular" ? b.reviews - a.reviews : state.sort === "time" ? a.time - b.time : state.sort === "rated" ? b.rating - a.rating : state.sort === "az" ? a.title.localeCompare(b.title) : state.sort === "newest" ? b.newest - a.newest : a.newest - b.newest);
      return out;
    }
    function card(recipe) {
      const active = bookmarks.includes(recipe.id);
      return `<article class="recipe-card reveal-up is-visible" data-recipe-id="${recipe.id}">
        <div class="recipe-image" data-view-recipe="${recipe.id}"><img src="${recipe.image}" alt="${recipe.title}" loading="lazy"><span class="recipe-badge">${recipe.category}</span><div class="recipe-card-actions"><button class="${active ? "is-bookmarked" : ""}" type="button" data-recipe-bookmark="${recipe.id}" aria-label="Bookmark ${recipe.title}"><i class="bi bi-bookmark${active ? "-fill" : ""}"></i></button><button type="button" data-recipe-quick="${recipe.id}" aria-label="Quick view ${recipe.title}"><i class="bi bi-eye"></i></button></div></div>
        <div class="recipe-card-body"><h3><a href="recipe-details.html?id=${recipe.id}">${highlight(recipe.title)}</a></h3><p>${highlight(recipe.description)}</p><div class="recipe-meta"><span><i class="bi bi-clock"></i> ${recipe.time < 60 ? `${recipe.time} mins` : recipe.time === 60 ? "1 hr" : `${Math.round(recipe.time / 60 * 10) / 10} hrs`}</span><span class="recipe-spice">${spiceIcon(recipe.spice)}</span><button class="recipe-bookmark-inline ${active ? "is-bookmarked" : ""}" type="button" data-recipe-bookmark="${recipe.id}" aria-label="Bookmark ${recipe.title}"><i class="bi bi-bookmark${active ? "-fill" : ""}"></i></button></div></div>
      </article>`;
    }
    function render() {
      const all = list();
      ...
      const visible = all.slice((state.page - 1) * perPage(), state.page * perPage());
      grid.innerHTML = visible.map(card).join("");
      count.textContent = `(${all.length})`;
      empty.hidden = all.length !== 0;
      pagination.innerHTML = all.length ? `<button type="button" data-recipe-page="${Math.max(1, state.page - 1)}"><i class="bi bi-chevron-left"></i></button>${Array.from({length: pages}, (_, i) => `<button type="button" class="${i + 1 === state.page ? "active" : ""}" data-recipe-page="${i + 1}">${i + 1}</button>`).join("")}<button type="button" data-recipe-page="${Math.min(pages, state.page + 1)}"><i class="bi bi-chevron-right"></i></button>` : "";
    }
    function quick(recipe) {
      quickBody.innerHTML = `<div class="recipe-quick-layout"><img src="${recipe.image}" alt="${recipe.title}" loading="lazy"><div class="recipe-quick-content"><p class="eyebrow">${recipe.category}</p><h2 id="recipeQuickTitle">${recipe.title}</h2><div class="catalog-rating">${catalogStars(recipe.rating)}<small>(${recipe.reviews})</small></div><p>${recipe.description}</p><ul><li>Ingredients: ${recipe.ingredients}</li><li>Cooking Time: ${recipe.time} mins</li><li>Difficulty: ${recipe.difficulty}</li><li>Calories: ${recipe.calories} kcal</li><li>Spice Level: ${recipe.spice}</li></ul><a class="btn btn-gold" href="recipe-details.html?id=${recipe.id}">View Recipe <i class="bi bi-arrow-right"></i></a></div></div>`;
      window.bootstrap?.Modal.getOrCreateInstance(document.querySelector("#recipeQuickModal")).show();
    }
    document.querySelector("#recipeFilters").innerHTML = filterMarkup();
    document.querySelector("#recipeMobileFilters").innerHTML = filterMarkup();
    document.addEventListener("change", (e) => { if (e.target.matches("[data-recipe-filter]")) { state.page = 1; render(); } });
    let searchTimer;
    search.addEventListener("input", () => { clearTimeout(searchTimer); searchTimer = setTimeout(() => { state.search = search.value.trim(); state.page = 1; render(); }, 220); });
    sort.addEventListener("change", () => { state.sort = sort.value; state.page = 1; render(); });
    document.addEventListener("click", (e) => {
      const page = e.target.closest("[data-recipe-page]");
      const bookmark = e.target.closest("[data-recipe-bookmark]");
      const quickBtn = e.target.closest("[data-recipe-quick]");
      const view = e.target.closest("[data-view-recipe]");
      if (!page && !bookmark && !quickBtn && !view && !e.target.closest("[data-recipe-clear]") && !e.target.closest("[data-recipe-apply]")) return;
      if (page) { state.page = Number(page.dataset.recipePage); render(); }
      if (bookmark) { const id = bookmark.dataset.recipeBookmark; const active = bookmarks.includes(id); bookmarks = active ? bookmarks.filter((x) => x !== id) : [...bookmarks, id]; localStorage.setItem("svaadvika-recipe-bookmarks", JSON.stringify(bookmarks)); showToast(active ? "Recipe removed from bookmarks" : "Recipe bookmarked", active ? "bi-bookmark" : "bi-bookmark-fill"); render(); }
      if (quickBtn) quick(recipes.find((r) => r.id === quickBtn.dataset.recipeQuick));
      if (view && !e.target.closest("button")) window.location.href = `recipe-details.html?id=${view.dataset.viewRecipe}`;
      if (e.target.closest("[data-recipe-clear]")) { document.querySelectorAll("[data-recipe-filter]").forEach((input) => input.checked = false); state.page = 1; render(); }
      if (e.target.closest("[data-recipe-apply]")) { state.page = 1; render(); }
    });
    document.querySelector("#recipeNewsletter")?.addEventListener("submit", (event) => {
      event.preventDefault();
      if (!event.currentTarget.checkValidity()) { event.currentTarget.classList.add("was-validated"); return; }
      showToast("Subscribed to delicious recipes", "bi-envelope-check-fill");
