        ...
        <form action="{{ route('admin.testimonials.update', $testimonial) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="designation" class="form-control @error('designation') is-invalid @enderror" value="{{ old('designation', $testimonial->designation) }}" placeholder="e.g. Food Blogger, Mumbai">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        @if($testimonial->avatar)
                            <img src="{{ asset('storage/' . $testimonial->avatar) }}" alt="Avatar" class="rounded-circle border" width="60" height="60" style="object-fit: cover;">
                        @endif
                        <div class="flex-grow-1">
                            <input type="file" name="avatar" class="form-control @error('avatar') is-invalid @enderror" accept="image/*">
                            <small class="text-muted">Leave blank to keep existing. Recommended size: 100x100px.</small>
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" name="sort_order" class="form-control @error('sort_order') is-invalid @enderror" value="{{ old('sort_order', $testimonial->sort_order) }}" required>
