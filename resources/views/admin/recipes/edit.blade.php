                    ...
                    <div class="card border-0 shadow-sm glass-effect mb-4">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="schema_markup" class="form-control @error('schema_markup') is-invalid @enderror" rows="4" placeholder='<script type="application/ld+json">{...}</script>'>{{ old('schema_markup', $recipe->schema_markup) }}</textarea>
