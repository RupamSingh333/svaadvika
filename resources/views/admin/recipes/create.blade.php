                    ...
                    <div class="card border-0 shadow-sm glass-effect mb-4">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="ingredients" class="form-control @error('ingredients') is-invalid @enderror" rows="3" placeholder="e.g. 1 cup Basmati Rice, 2 tbsp Ghee, 1 tsp Cumin Seeds">{{ old('ingredients') }}</textarea>
                    ...
                    <div class="card border-0 shadow-sm glass-effect mb-4">
                        ...
                        <div class="card-body p-4">
                            <div class="mb-4">
                                ...
                                <input type="text" name="meta_title" class="form-control @error('meta_title') is-invalid @enderror" value="{{ old('meta_title') }}" placeholder="Leave blank to auto-generate from recipe title">
                                @error('meta_title')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="mb-4">
                                <label class="form-label fw-semibold">Meta Description</label>
                                <textarea name="meta_description" class="form-control @error('meta_description') is-invalid @enderror" rows="3" placeholder="Leave blank to auto-generate from recipe description">{{ old('meta_description') }}</textarea>
