                    ...
                    <div class="card border-0 shadow-sm glass-effect mb-4">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="url" name="video_url" id="videoUrlInput" class="form-control" placeholder="YouTube, Instagram, or MP4 Video Link" value="{{ old('video_url') }}">
                    ...
                    <div class="card border-0 shadow-sm glass-effect mb-4">
                        ...
                        <div class="card-body p-4">
                            <div class="mb-4">
                                ...
                                <input type="text" name="meta_title" class="form-control @error('meta_title') is-invalid @enderror" value="{{ old('meta_title') }}" placeholder="Leave blank to auto-generate from product name">
                                @error('meta_title')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="mb-4">
                                <label class="form-label fw-semibold">Meta Description</label>
                                <textarea name="meta_description" class="form-control @error('meta_description') is-invalid @enderror" rows="3" placeholder="Leave blank to auto-generate from product description">{{ old('meta_description') }}</textarea>
                                @error('meta_description')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="mb-4">
                                <label class="form-label fw-semibold">Meta Keywords</label>
                                <input type="text" name="meta_keywords" class="form-control @error('meta_keywords') is-invalid @enderror" value="{{ old('meta_keywords') }}" placeholder="e.g. biryani, ready to cook, indian food">
