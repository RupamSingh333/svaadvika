                        ...
                        <div class="card-body p-4">
                            <div class="mb-4">
                                ...
                                <select name="type" class="form-select @error('type') is-invalid @enderror" required>
                                    <option value="page" {{ old('type', $post->type) == 'page' ? 'selected' : '' }}>Static Page</option>
                                    <option value="blog" {{ old('type', $post->type) == 'blog' ? 'selected' : '' }}>Blog Post</option>
                                    <option value="recipe" {{ old('type', $post->type) == 'recipe' ? 'selected' : '' }}>Recipe</option>
                                </select>
                            ...
                            <div class="d-grid gap-2">
                                <button type="submit" class="btn btn-primary"><i class="fa-solid fa-save me-2"></i> Update Content</button>
