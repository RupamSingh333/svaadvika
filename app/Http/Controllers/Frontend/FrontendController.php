    ...
    public function products()
    {
        ...
        $formattedProducts = $products->map(function ($product, $index) {
            ...
            return [
                ...
                'title' => $product->name,
                'description' => \Illuminate\Support\Str::words(strip_tags($product->short_description ?? ''), 20, '...'),
    ...
    public function productDetails($slug)
    {
        ...
        $formatProduct = function ($prod, $idx = 0) {
            ...
            return [
                ...
                'title' => $prod->name,
                'description' => \Illuminate\Support\Str::words(strip_tags($prod->short_description ?? ''), 20, '...'),
                'rating' => (float) $averageRating,
                'reviews' => (int) $reviewsCount,
